...
bool CSoundManager::Load( HWND hWnd )
{
	...
	SoundList SList[] =
	{
		...
		{ enList::BGM_NatureHeroSelect, _T( "Data\\Sound\\BGM\\NatureHeroSelect.mp3" ),		_T( "BGM_NatureHeroSelect" )},
		{ enList::BGM_Nature,		    _T( "Data\\Sound\\BGM\\Nature.mp3" ),				_T( "BGM_Nature" )		},
		...
		{ enList::BGM_NatureResult,		_T( "Data\\Sound\\BGM\\NatureResult.mp3" ),			_T( "BGM_NatureResult" )},
