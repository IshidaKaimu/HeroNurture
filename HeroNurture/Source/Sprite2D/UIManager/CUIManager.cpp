...
HRESULT CUIManager::Load(CDirectX11* dx11)
{
	...
	{																		//表示サイズ     //元画像サイズ  //1コマ当たりの表示サイズ
		...
		{UIList::HpGauge,	     _T("Data\\Texture\\HpGauge.png")		   ,{ 602.0f, 58.0f,  602.0f, 58.0f,  602.0f, 58.0f}},
		{UIList::EnemyHpGauge,	 _T("Data\\Texture\\EnemyHpGauge.png")	   ,{ 602.0f, 58.0f,  602.0f, 58.0f,  602.0f, 58.0f}},
		...
		{UIList::GaugeDecrease,	 _T("Data\\Texture\\GaugeDecrease.png")    ,{ 602.0f, 58.0f,  602.0f, 58.0f,  602.0f, 58.0f}},
