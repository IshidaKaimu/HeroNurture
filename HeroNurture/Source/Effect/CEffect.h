...
public:
	...
	//描画
	void Draw( const D3DXMATRIX& mView, D3DXMATRIX& mProj, const LIGHT& Light, const CAMERA& Camera );
	...
	//速度
	void Speed(::EsHandle handle, float speed)
	{
...
private:
	...
	//ビュー行列を設定
	void SetViewMatRix( const D3DXMATRIX& m_View );
	...
	{
		m_pManager->SetRotation(m_Handle, x, y, z);
	};
